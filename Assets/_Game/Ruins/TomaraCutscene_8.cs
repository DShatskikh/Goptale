...
public sealed class TomaraCutscene_8 : MonoBehaviour
{
    [SerializeField]
    ...
    private IEnumerator AwaitTrigger()
    {
        ...
        yield return DialogueWindow.StartDialogue(new [] {
            "\\T1Ты хочешь узнать, как вернуться \"домой\", не так ли?",
            "\\T1Впереди нас находится конец РУИНИНО.",
            "\\T1Я собираюсь разрушить его.",
            "\\T1Никто не сможет выбраться снова.",
            "\\T1Теперь будь хорошим пациком и поднимись наверх.",
            "\\T1Ты очень наивен...*Если ты покинешь РУИНИНО...",
            "\\T1Тебя окучат <color=\"red\">менты</color> и ты сядешь в тюрьму.", 
            "\\T1Я лишь защищаю тебя, ты это понимаешь?",
            "\\T1... иди на вверх.",
            "\\T1Не пытайся меня остановить.",
            "\\T1Это последнее предупреждение для тебя.",
        });
