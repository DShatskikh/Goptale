...
public sealed class TamaraCutscene_9 : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject[] _otherObjects, _otherObjects2;
    ...
    private IEnumerator Start()
    {
        ...
        if (Stats.Instance.TomaraCutscene == 15) // Победили мирно
        {
            ...
            Fedya.Instance.transform.position = new Vector3(6.09919977f,12.9584999f,0);
    ...
    private IEnumerator AwaitTrigger()
    {
        ...
        else
        {
            yield return DialogueWindow.StartDialogue(new [] {
                ...
                "\\T1Хм.",
                "\\T1Ты такой же, %как и другие.",
                "\\T1Ты останешься тут.",
                "\\T1Дальше я тебя...*Не пущу!",
            }, true);
            ...
            foreach (var otherObject in _otherObjects2)
            {
